...
const MiddleContact = () =>{
   return (
     <div className="flex mt-[80px] justify-center items-center drop-shadow-lg border py-8">
         <div className="w-[500px] h-[120px] text-center text-lg">
         ...
         <div className="w-[500px] h-[120px] text-center text-lg border-l border-r border-gray-500 ">
